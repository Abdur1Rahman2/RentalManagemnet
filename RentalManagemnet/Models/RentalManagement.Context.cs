...
namespace RentalManagemnet.Models
{
    ...
    public partial class RentalManagementEntities2 : DbContext
    {
        public RentalManagementEntities2()
            : base("name=RentalManagementEntities2")
        {
        }
        ...
        public virtual int deleteProperty(Nullable<int> propertyID)
        {
            var propertyIDParameter = propertyID.HasValue ?
                new ObjectParameter("propertyID", propertyID) :
                new ObjectParameter("propertyID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("deleteProperty", propertyIDParameter);
        }
